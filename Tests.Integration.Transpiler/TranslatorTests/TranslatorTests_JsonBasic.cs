...
namespace Tests.Integration.Transpiler
{
    ...
    /// </summary>
    internal class JsonBasicTranslatorTests : TestsBase
    {
        public static string outputDir = @"C:\Users\Viktor Chernev\Desktop\testing\TranslatorTests\JsonBasicTranslatorTests";
        ...
        internal static void TestFile(string embeddedName)
        {
            ...
            JsonBasicTranslator translator = new JsonBasicTranslator(ConsoleLog, ConsoleLogError, ConsoleLogInfo);
