...
namespace DescribeParser.Ast
{
    public static class AstFactory
    {
        ...
        {
            return _createLeafNode(leaftype, text, null, position, parent);
        }

        public static AstLeafNode CreateLeafNode(AstLeafType leaftype, string text, string trivia,
            SourcePosition position, IAstBranchNode parent = null)
        {
            return _createLeafNode(leaftype, text, trivia, position, parent);
        }

        static AstLeafNode _createLeafNode(AstLeafType leaftype, 
            string text, string trivia, SourcePosition position, IAstBranchNode parent)
        {
