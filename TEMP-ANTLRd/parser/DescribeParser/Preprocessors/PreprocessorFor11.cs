...
{
    internal class PreprocessorFor11 : IDescribePreprocessor
    {
        ...
        void readLanguageVersion(string value)
        {
            ...
            //else if (value.StartsWith("0.7>")) 
            //else if (value.StartsWith("0.8>")) 
            //else if (value.StartsWith("0.9>")) 
            //else if (value.StartsWith("1.0>")) 
