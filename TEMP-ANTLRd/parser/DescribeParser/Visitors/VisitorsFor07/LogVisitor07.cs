...
namespace DescribeParser.Visitors
{
    ...
    public class LogVisitor07 : Describe07BaseVisitor<object>
    {
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                else if (child is ParserRuleContext childContext)
                {
                    if (child is Describe07Parser.ExpressionContext)
                        VisitExpression((Describe07Parser.ExpressionContext)child);
                    else if (child is Describe07Parser.Expression_listContext)
                        VisitExpression_list((Describe07Parser.Expression_listContext)child);
                    else if (child is Describe07Parser.ItemContext)
                        VisitItem((Describe07Parser.ItemContext)child);
                    else if (child is Describe07Parser.Item_or_expression_listContext)
                        VisitItem_or_expression_list((Describe07Parser.Item_or_expression_listContext)child);
                    else if (child is Describe07Parser.Item_or_expression_partContext)
                        VisitItem_or_expression_part((Describe07Parser.Item_or_expression_partContext)child);
                    else if (child is Describe07Parser.Text_chunkContext)
                        VisitText_chunk((Describe07Parser.Text_chunkContext)child);
                    else if (child is Describe07Parser.TagContext)
                        VisitTag((Describe07Parser.TagContext)child);
                    else if (child is Describe07Parser.ProducerContext)
                        VisitProducer((Describe07Parser.ProducerContext)child);
                }
        ...
        public override string VisitTag([NotNull] Describe07Parser.TagContext context)
        {
