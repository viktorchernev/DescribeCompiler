...
public partial class Describe10Parser : Parser {
	...
	public Text_chunkContext text_chunk() {
		...
		try {
			...
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 1073738048L) != 0)) ) {
		...
		try {
			...
			case 2:
				...
				do {
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 1073738048L) != 0) );
				State = 35;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				do {
	...
	private static int[] _serializedATN = {
		...
		7,1,7,0,0,8,0,2,4,6,8,10,12,14,0,1,3,0,6,6,8,8,12,29,340,0,16,1,0,0,0,
		...
		226,227,3,0,0,0,227,228,3,10,5,0,228,229,5,11,0,0,229,245,1,0,0,0,230,
		231,3,4,2,0,231,232,3,0,0,0,232,233,3,4,2,0,233,234,5,11,0,0,234,245,1,
		0,0,0,235,236,3,4,2,0,236,237,3,0,0,0,237,238,3,6,3,0,238,239,5,11,0,0,
		239,245,1,0,0,0,240,241,3,4,2,0,241,242,3,0,0,0,242,243,5,11,0,0,243,245,
		1,0,0,0,244,225,1,0,0,0,244,230,1,0,0,0,244,235,1,0,0,0,244,240,1,0,0,
		0,245,7,1,0,0,0,246,247,3,4,2,0,247,248,5,10,0,0,248,254,1,0,0,0,249,251,
		3,6,3,0,250,252,5,10,0,0,251,250,1,0,0,0,251,252,1,0,0,0,252,254,1,0,0,
