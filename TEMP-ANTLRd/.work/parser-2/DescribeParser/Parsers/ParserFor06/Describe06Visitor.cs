...
public interface IDescribe06Visitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="Describe06Parser.item_or_expression_part_tail"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitItem_or_expression_part_tail([NotNull] Describe06Parser.Item_or_expression_part_tailContext context);
	/// <summary>
