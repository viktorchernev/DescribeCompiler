...
public partial class Describe06BaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IDescribe06Visitor<Result> {
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitItem_or_expression_part_tail([NotNull] Describe06Parser.Item_or_expression_part_tailContext context) { return VisitChildren(context); }
	/// <summary>
