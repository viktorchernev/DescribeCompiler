...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor10.C_multiple_mixed_comments.ds"
    namespace - NULL
    Exception - NULL
