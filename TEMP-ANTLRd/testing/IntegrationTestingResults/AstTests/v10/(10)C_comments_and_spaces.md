...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor10.C_comments_and_spaces.ds"
    namespace - NULL
    Exception - NULL
