...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor10.E_escaped_double_commas.ds"
    namespace - NULL
    Exception - NULL
