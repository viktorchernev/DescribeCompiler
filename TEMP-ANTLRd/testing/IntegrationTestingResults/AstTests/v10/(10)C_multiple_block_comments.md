...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor10.C_multiple_block_comments.ds"
    namespace - NULL
    Exception - NULL
