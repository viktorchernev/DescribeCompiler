...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor07.D_escaped_double_characters2.ds"
    namespace - NULL
    Exception - NULL
