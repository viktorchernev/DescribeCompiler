...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor07.D_escaped_double_characters3.ds"
    namespace - NULL
    Exception - NULL
