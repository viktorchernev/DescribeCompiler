...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor07.E_spaces_escapes_N.ds"
    namespace - NULL
    Exception - NULL
