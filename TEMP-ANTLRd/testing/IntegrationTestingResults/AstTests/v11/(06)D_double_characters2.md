...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor06.D_double_characters2.ds"
    namespace - NULL
    Exception - NULL
