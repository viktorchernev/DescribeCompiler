...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor06.F_production_in_production6.ds"
    namespace - NULL
    Exception - NULL
