...
Scripture : 
    ...
    filename - "DescribeParser.IntegrationTests.TestFiles.TestFilesFor06.D_double_characters3.ds"
    namespace - NULL
    Exception - NULL
