...
{
    public class UnfoldVisitor11V2 : Describe11BaseVisitor<object>, IUnfoldVisitorV2
    {
        // Misc
        ...
        {
            if (context is not Describe11Parser.ScriptureContext)
                throw new Exception("context is Not Describe11Parser.ScriptureContext");

            return DoScripture(u, context as Describe11Parser.ScriptureContext, filename);
        }
        ...
        /// <param name="context">Root context produced by the parser aka the parse tree</param>
        /// <returns>True if successful</returns>
        public bool DoScripture(DescribeUnfoldV2 u, Describe11Parser.ScriptureContext context, string filename = "")
        {
        ...
        /// </summary>
        private string[] DoExpressionList(DescribeUnfoldV2 u, Describe11Parser.Expression_listContext context, bool isPrimery = false)
        {
        ...
        /// </summary>
        private string[] DoItemOrExpressionList(DescribeUnfoldV2 u, Describe11Parser.Item_or_expression_listContext context)
        {
            int childCount = context.ChildCount;
            List<string> keys = new List<string>();
        ...
        /// </summary>
        private string DoExpression(DescribeUnfoldV2 u, Describe11Parser.ExpressionContext context)
        {
            int childCount = context.ChildCount;
        ...
        /// </summary>
        private string DoItem(DescribeUnfoldV2 u, Describe11Parser.ItemContext context)
        {
            int childCount = context.ChildCount;
            string text = "";
            string tag = "";
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                if(child is Describe11Parser.Text_chunkContext)
                {
