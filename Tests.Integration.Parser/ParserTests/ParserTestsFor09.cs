...
{
    internal class ParserTestsFor09 : ParserTestsBase
    {
        public static string outputDir = @"C:\Users\Viktor Chernev\Desktop\ANTLRd\testing\IntegrationTestingResults\ParserTests\v09";
        ...
        internal static void TestFile(string embeddedName, bool insertMissingTerminators = true)
        {
            ...
            lexer = new Describe09Lexer(inputstream);
        ...
        static void TestFilesFor09(bool pressKey = true, bool insertMissingTerminators = true)
        {
            ...
            //press key to exit
            Console.WriteLine("");
            Console.WriteLine("Tests for 09 concluded. Press any key to continue/exit.");
            if (pressKey) Console.ReadLine();
        }
        ...
        static int GetTokenTypeIndex(string tokenName)
        {
            ...
            while (true)
            {
                var nameIndex = Describe09Lexer.DefaultVocabulary.GetSymbolicName(i);
