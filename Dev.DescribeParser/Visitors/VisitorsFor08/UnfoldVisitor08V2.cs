...
{
    public class UnfoldVisitor08V2 : Describe08BaseVisitor<object>, IUnfoldVisitorV2
    {
        // Misc
        ...
        {
            if (context is not Describe08Parser.ScriptureContext)
                throw new Exception("context is Not Describe08Parser.ScriptureContext");

            return DoScripture(u, context as Describe08Parser.ScriptureContext, filename);
        }
        ...
        /// <param name="context">Root context produced by the parser aka the parse tree</param>
        /// <returns>True if successful</returns>
        public bool DoScripture(DescribeUnfoldV2 u, Describe08Parser.ScriptureContext context, string filename = "")
        {
        ...
        /// </summary>
        private string[] DoExpressionList(DescribeUnfoldV2 u, Describe08Parser.Expression_listContext context, bool isPrimery = false)
        {
        ...
        /// </summary>
        private string[] DoItemOrExpressionList(DescribeUnfoldV2 u, Describe08Parser.Item_or_expression_listContext context)
        {
            int childCount = context.ChildCount;
            List<string> keys = new List<string>();
        ...
        /// </summary>
        private string DoExpression(DescribeUnfoldV2 u, Describe08Parser.ExpressionContext context)
        {
            int childCount = context.ChildCount;
        ...
        /// </summary>
        private string DoItem(DescribeUnfoldV2 u, Describe08Parser.ItemContext context)
        {
            int childCount = context.ChildCount;
            string text = "";
            string tag = "";
