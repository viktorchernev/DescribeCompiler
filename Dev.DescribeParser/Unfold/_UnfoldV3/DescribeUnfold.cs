...
namespace DescribeParser.Unfold
{
    ...
    public partial class DescribeUnfoldV3
    {
        ...
        /// </summary>
        public Dictionary<int, List<DescribeLink>> Links;

        /// <summary>
        /// Gets or sets the dictionary of decorators (item ID - decorators for that item).
        /// </summary>
        public Dictionary<int, List<DescribeDecorator>> Decorators;
        ...
        public DescribeUnfoldV3()
        {
            ...
            Links = new Dictionary<int, List<DescribeLink>>();
            Decorators = new Dictionary<int, List<DescribeDecorator>>();
