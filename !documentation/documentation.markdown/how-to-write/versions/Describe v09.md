...
permalink: /language/version-09/
exclude: true
---
<br>Describe version 0.9, code-named Decorators is the forth test version of the language. It introduced the concept of decorators - pieces of particular data with their own syntax, enclosed in curly brackets  - ```{color|tomato}{bold}```
