...
permalink: /language/version-08/
exclude: true
---
<br>Describe version 0.8, code-named Links is the third test version of the language. It introduced the concept of links, written in square brackets - ```[https://someurl.net/]```
