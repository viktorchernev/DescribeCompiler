...
public partial class Describe11Parser : Parser {
	...
	public Text_chunkContext text_chunk() {
		...
		try {
			...
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 137438951744L) != 0)) ) {
		...
		try {
			...
			case 2:
				...
				do {
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 137438951744L) != 0) );
				State = 41;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				do {
	...
	private static int[] _serializedATN = {
		4,1,36,332,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,7,
		...
		8,8,11,36,400,0,16,1,0,0,0,2,19,1,0,0,0,4,268,1,0,0,0,6,289,1,0,0,0,8,
