...
public partial class Describe11Parser : Parser {
	...
	public partial class Text_chunkContext : ParserRuleContext {
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode ESCAPE_TILDE() { return GetToken(Describe11Parser.ESCAPE_TILDE, 0); }
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode ESCAPE_COLON() { return GetToken(Describe11Parser.ESCAPE_COLON, 0); }
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode PROTO_SLASHES() { return GetToken(Describe11Parser.PROTO_SLASHES, 0); }
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode COLON() { return GetToken(Describe11Parser.COLON, 0); }
	...
	public Text_chunkContext text_chunk() {
		...
		try {
			...
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 549755810434L) != 0)) ) {
		...
		try {
			...
			case 2:
				...
				do {
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 549755810434L) != 0) );
				State = 41;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				do {
	...
	private static int[] _serializedATN = {
		4,1,38,332,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,7,
		...
		7,7,9,9,12,38,400,0,16,1,0,0,0,2,19,1,0,0,0,4,268,1,0,0,0,6,289,1,0,0,
