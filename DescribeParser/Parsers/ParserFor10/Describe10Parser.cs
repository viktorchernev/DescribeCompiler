...
public partial class Describe10Parser : Parser {
	...
	public const int
		...
		STAR=19, ESCAPE_ESCAPE=20, ESCAPE_HYPHEN=21, ESCAPE_TILDE=22, ESCAPE_RIGHT_ARROW=23, 
		ESCAPE_LEFT_ARROW=24, ESCAPE_RIGHT_SQUARE=25, ESCAPE_LEFT_SQUARE=26, ESCAPE_RIGHT_CURL=27, 
		ESCAPE_LEFT_CURL=28, ESCAPE_SEPARATOR=29, ESCAPE_TERMINATOR=30, ESCAPE_COLON=31, 
		ESCAPE_LCOMMENT=32, ESCAPE_BCOMMENT=33, ESCAPE=34, DATA=35;
	public const int
	...
	public partial class Text_chunkContext : ParserRuleContext {
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode ESCAPE_TILDE() { return GetToken(Describe10Parser.ESCAPE_TILDE, 0); }
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode ESCAPE_COLON() { return GetToken(Describe10Parser.ESCAPE_COLON, 0); }
		...
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode PROTO_SLASHES() { return GetToken(Describe10Parser.PROTO_SLASHES, 0); }
		[System.Diagnostics.DebuggerNonUserCode] public ITerminalNode COLON() { return GetToken(Describe10Parser.COLON, 0); }
	...
	public Text_chunkContext text_chunk() {
		...
		try {
			...
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 68719473282L) != 0)) ) {
		...
		try {
			...
			case 2:
				...
				do {
					...
					ErrorHandler.Sync(this);
					_la = TokenStream.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 68719473282L) != 0) );
				State = 41;
				ErrorHandler.Sync(this);
				_la = TokenStream.LA(1);
				do {
	...
	private static int[] _serializedATN = {
		...
		7,1,7,1,7,1,7,1,7,3,7,330,8,7,1,7,0,0,8,0,2,4,6,8,10,12,14,0,1,4,0,1,1,
		7,7,9,9,12,35,400,0,16,1,0,0,0,2,19,1,0,0,0,4,268,1,0,0,0,6,289,1,0,0,
		0,8,298,1,0,0,0,10,314,1,0,0,0,12,317,1,0,0,0,14,329,1,0,0,0,16,17,5,7,
		0,0,17,18,5,9,0,0,18,1,1,0,0,0,19,20,7,0,0,0,20,3,1,0,0,0,21,23,5,8,0,
		0,22,21,1,0,0,0,22,23,1,0,0,0,23,25,1,0,0,0,24,26,3,2,1,0,25,24,1,0,0,
		0,26,27,1,0,0,0,27,25,1,0,0,0,27,28,1,0,0,0,28,30,1,0,0,0,29,31,5,4,0,
		0,30,29,1,0,0,0,30,31,1,0,0,0,31,269,1,0,0,0,32,34,5,8,0,0,33,32,1,0,0,
		0,33,34,1,0,0,0,34,36,1,0,0,0,35,37,3,2,1,0,36,35,1,0,0,0,37,38,1,0,0,
		0,38,36,1,0,0,0,38,39,1,0,0,0,39,41,1,0,0,0,40,42,5,5,0,0,41,40,1,0,0,
		0,42,43,1,0,0,0,43,41,1,0,0,0,43,44,1,0,0,0,44,269,1,0,0,0,45,47,5,8,0,
		0,46,45,1,0,0,0,46,47,1,0,0,0,47,49,1,0,0,0,48,50,3,2,1,0,49,48,1,0,0,
		0,50,51,1,0,0,0,51,49,1,0,0,0,51,52,1,0,0,0,52,54,1,0,0,0,53,55,5,6,0,
		0,54,53,1,0,0,0,55,56,1,0,0,0,56,54,1,0,0,0,56,57,1,0,0,0,57,269,1,0,0,
		0,58,60,5,8,0,0,59,58,1,0,0,0,59,60,1,0,0,0,60,62,1,0,0,0,61,63,3,2,1,
		0,62,61,1,0,0,0,63,64,1,0,0,0,64,62,1,0,0,0,64,65,1,0,0,0,65,67,1,0,0,
		0,66,68,5,5,0,0,67,66,1,0,0,0,68,69,1,0,0,0,69,67,1,0,0,0,69,70,1,0,0,
		0,70,71,1,0,0,0,71,72,5,4,0,0,72,269,1,0,0,0,73,75,5,8,0,0,74,73,1,0,0,
		0,74,75,1,0,0,0,75,77,1,0,0,0,76,78,3,2,1,0,77,76,1,0,0,0,78,79,1,0,0,
		0,79,77,1,0,0,0,79,80,1,0,0,0,80,81,1,0,0,0,81,83,5,4,0,0,82,84,5,5,0,
		0,83,82,1,0,0,0,84,85,1,0,0,0,85,83,1,0,0,0,85,86,1,0,0,0,86,269,1,0,0,
		0,87,89,5,8,0,0,88,87,1,0,0,0,88,89,1,0,0,0,89,91,1,0,0,0,90,92,3,2,1,
		0,91,90,1,0,0,0,92,93,1,0,0,0,93,91,1,0,0,0,93,94,1,0,0,0,94,96,1,0,0,
		0,95,97,5,6,0,0,96,95,1,0,0,0,97,98,1,0,0,0,98,96,1,0,0,0,98,99,1,0,0,
		0,99,100,1,0,0,0,100,101,5,4,0,0,101,269,1,0,0,0,102,104,5,8,0,0,103,102,
		1,0,0,0,103,104,1,0,0,0,104,106,1,0,0,0,105,107,3,2,1,0,106,105,1,0,0,
		0,107,108,1,0,0,0,108,106,1,0,0,0,108,109,1,0,0,0,109,110,1,0,0,0,110,
		112,5,4,0,0,111,113,5,6,0,0,112,111,1,0,0,0,113,114,1,0,0,0,114,112,1,
		0,0,0,114,115,1,0,0,0,115,269,1,0,0,0,116,118,5,8,0,0,117,116,1,0,0,0,
		117,118,1,0,0,0,118,120,1,0,0,0,119,121,3,2,1,0,120,119,1,0,0,0,121,122,
		1,0,0,0,122,120,1,0,0,0,122,123,1,0,0,0,123,125,1,0,0,0,124,126,5,6,0,
		0,125,124,1,0,0,0,126,127,1,0,0,0,127,125,1,0,0,0,127,128,1,0,0,0,128,
		130,1,0,0,0,129,131,5,5,0,0,130,129,1,0,0,0,131,132,1,0,0,0,132,130,1,
		0,0,0,132,133,1,0,0,0,133,269,1,0,0,0,134,136,5,8,0,0,135,134,1,0,0,0,
		135,136,1,0,0,0,136,138,1,0,0,0,137,139,3,2,1,0,138,137,1,0,0,0,139,140,
		1,0,0,0,140,138,1,0,0,0,140,141,1,0,0,0,141,143,1,0,0,0,142,144,5,5,0,
		0,143,142,1,0,0,0,144,145,1,0,0,0,145,143,1,0,0,0,145,146,1,0,0,0,146,
		148,1,0,0,0,147,149,5,6,0,0,148,147,1,0,0,0,149,150,1,0,0,0,150,148,1,
		0,0,0,150,151,1,0,0,0,151,269,1,0,0,0,152,154,5,8,0,0,153,152,1,0,0,0,
		153,154,1,0,0,0,154,156,1,0,0,0,155,157,3,2,1,0,156,155,1,0,0,0,157,158,
		1,0,0,0,158,156,1,0,0,0,158,159,1,0,0,0,159,160,1,0,0,0,160,162,5,4,0,
		0,161,163,5,6,0,0,162,161,1,0,0,0,163,164,1,0,0,0,164,162,1,0,0,0,164,
		165,1,0,0,0,165,167,1,0,0,0,166,168,5,5,0,0,167,166,1,0,0,0,168,169,1,
		0,0,0,169,167,1,0,0,0,169,170,1,0,0,0,170,269,1,0,0,0,171,173,5,8,0,0,
		172,171,1,0,0,0,172,173,1,0,0,0,173,175,1,0,0,0,174,176,3,2,1,0,175,174,
		1,0,0,0,176,177,1,0,0,0,177,175,1,0,0,0,177,178,1,0,0,0,178,180,1,0,0,
		0,179,181,5,6,0,0,180,179,1,0,0,0,181,182,1,0,0,0,182,180,1,0,0,0,182,
		183,1,0,0,0,183,184,1,0,0,0,184,186,5,4,0,0,185,187,5,5,0,0,186,185,1,
		0,0,0,187,188,1,0,0,0,188,186,1,0,0,0,188,189,1,0,0,0,189,269,1,0,0,0,
		190,192,5,8,0,0,191,190,1,0,0,0,191,192,1,0,0,0,192,194,1,0,0,0,193,195,
		3,2,1,0,194,193,1,0,0,0,195,196,1,0,0,0,196,194,1,0,0,0,196,197,1,0,0,
		0,197,199,1,0,0,0,198,200,5,6,0,0,199,198,1,0,0,0,200,201,1,0,0,0,201,
		199,1,0,0,0,201,202,1,0,0,0,202,204,1,0,0,0,203,205,5,5,0,0,204,203,1,
		0,0,0,205,206,1,0,0,0,206,204,1,0,0,0,206,207,1,0,0,0,207,208,1,0,0,0,
		208,209,5,4,0,0,209,269,1,0,0,0,210,212,5,8,0,0,211,210,1,0,0,0,211,212,
		1,0,0,0,212,214,1,0,0,0,213,215,3,2,1,0,214,213,1,0,0,0,215,216,1,0,0,
		0,216,214,1,0,0,0,216,217,1,0,0,0,217,218,1,0,0,0,218,220,5,4,0,0,219,
		221,5,5,0,0,220,219,1,0,0,0,221,222,1,0,0,0,222,220,1,0,0,0,222,223,1,
		0,0,0,223,225,1,0,0,0,224,226,5,6,0,0,225,224,1,0,0,0,226,227,1,0,0,0,
		227,225,1,0,0,0,227,228,1,0,0,0,228,269,1,0,0,0,229,231,5,8,0,0,230,229,
		1,0,0,0,230,231,1,0,0,0,231,233,1,0,0,0,232,234,3,2,1,0,233,232,1,0,0,
		0,234,235,1,0,0,0,235,233,1,0,0,0,235,236,1,0,0,0,236,238,1,0,0,0,237,
		239,5,5,0,0,238,237,1,0,0,0,239,240,1,0,0,0,240,238,1,0,0,0,240,241,1,
		0,0,0,241,242,1,0,0,0,242,244,5,4,0,0,243,245,5,6,0,0,244,243,1,0,0,0,
		245,246,1,0,0,0,246,244,1,0,0,0,246,247,1,0,0,0,247,269,1,0,0,0,248,250,
		5,8,0,0,249,248,1,0,0,0,249,250,1,0,0,0,250,252,1,0,0,0,251,253,3,2,1,
		0,252,251,1,0,0,0,253,254,1,0,0,0,254,252,1,0,0,0,254,255,1,0,0,0,255,
		257,1,0,0,0,256,258,5,5,0,0,257,256,1,0,0,0,258,259,1,0,0,0,259,257,1,
		0,0,0,259,260,1,0,0,0,260,262,1,0,0,0,261,263,5,6,0,0,262,261,1,0,0,0,
		263,264,1,0,0,0,264,262,1,0,0,0,264,265,1,0,0,0,265,266,1,0,0,0,266,267,
		5,4,0,0,267,269,1,0,0,0,268,22,1,0,0,0,268,33,1,0,0,0,268,46,1,0,0,0,268,
		...
		2,0,271,272,3,0,0,0,272,273,3,10,5,0,273,274,5,11,0,0,274,290,1,0,0,0,
		275,276,3,4,2,0,276,277,3,0,0,0,277,278,3,4,2,0,278,279,5,11,0,0,279,290,
		1,0,0,0,280,281,3,4,2,0,281,282,3,0,0,0,282,283,3,6,3,0,283,284,5,11,0,
		0,284,290,1,0,0,0,285,286,3,4,2,0,286,287,3,0,0,0,287,288,5,11,0,0,288,
		290,1,0,0,0,289,270,1,0,0,0,289,275,1,0,0,0,289,280,1,0,0,0,289,285,1,
		0,0,0,290,7,1,0,0,0,291,292,3,4,2,0,292,293,5,10,0,0,293,299,1,0,0,0,294,
		296,3,6,3,0,295,297,5,10,0,0,296,295,1,0,0,0,296,297,1,0,0,0,297,299,1,
