            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                else if (child is ParserRuleContext childContext)
                {
                    if (child is Describe09Parser.ExpressionContext)
                        VisitExpression((Describe09Parser.ExpressionContext)child);
                    else if (child is Describe09Parser.Expression_listContext)
                        VisitExpression_list((Describe09Parser.Expression_listContext)child);
                    else if (child is Describe09Parser.ItemContext)
                        VisitItem((Describe09Parser.ItemContext)child);
                    else if (child is Describe09Parser.Item_or_expression_listContext)
                        VisitItem_or_expression_list((Describe09Parser.Item_or_expression_listContext)child);
                    else if (child is Describe09Parser.Item_or_expression_partContext)
