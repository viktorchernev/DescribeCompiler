...
{
    public class UnfoldVisitor09 : Describe09BaseVisitor<object>
    {
        // Misc
        ...
        public bool TranslateScripture(DescribeUnfold u, Describe09Parser.ScriptureContext context, string filename = "")
        {
