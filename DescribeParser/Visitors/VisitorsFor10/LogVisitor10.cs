...
namespace DescribeParser.Visitors
{
    ...
    /// </summary>
    public class LogVisitor10 : Describe10BaseVisitor<object>
    {
        /// <summary>
        /// Ctor.
        /// </summary>
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                else if (child is ParserRuleContext childContext)
                {
                    if (child is Describe10Parser.ExpressionContext)
                        VisitExpression((Describe10Parser.ExpressionContext)child);
                    else if (child is Describe10Parser.Expression_listContext)
                        VisitExpression_list((Describe10Parser.Expression_listContext)child);
                    else if (child is Describe10Parser.ItemContext)
                        VisitItem((Describe10Parser.ItemContext)child);
                    else if (child is Describe10Parser.Item_or_expression_listContext)
                        VisitItem_or_expression_list((Describe10Parser.Item_or_expression_listContext)child);
                    else if (child is Describe10Parser.Item_or_expression_partContext)
                        VisitItem_or_expression_part((Describe10Parser.Item_or_expression_partContext)child);
                    else if (child is Describe10Parser.Text_chunkContext)
                        VisitText_chunk((Describe10Parser.Text_chunkContext)child);
                    else if (child is Describe10Parser.ProducerContext)
                        VisitProducer((Describe10Parser.ProducerContext)child);
                }
        ...
        public override string VisitScripture([NotNull] Describe10Parser.ScriptureContext context)
        {
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitProducer([NotNull] Describe10Parser.ProducerContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitText_chunk([NotNull] Describe10Parser.Text_chunkContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitItem([NotNull] Describe10Parser.ItemContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitExpression([NotNull] Describe10Parser.ExpressionContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitExpression_list([NotNull] Describe10Parser.Expression_listContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitItem_or_expression_list([NotNull] Describe10Parser.Item_or_expression_listContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitItem_or_expression_part([NotNull] Describe10Parser.Item_or_expression_partContext context)
        {
            Validators.ValidateParserRuleContext(context);
