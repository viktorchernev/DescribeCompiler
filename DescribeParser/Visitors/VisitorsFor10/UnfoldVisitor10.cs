...
namespace DescribeParser.Visitors
{
    ...
    /// For Describe Language version 1.0
    /// </summary>
    public class UnfoldVisitor10
    {
        ...
        /// </summary>
        private string[] DoExpressionList(DescribeUnfold u, Describe10Parser.Expression_listContext context, bool isPrimery = false)
        {
        ...
        /// </summary>
        private string[] DoItemOrExpressionList(DescribeUnfold u, Describe10Parser.Item_or_expression_listContext context)
        {
            int childCount = context.ChildCount;
            List<string> keys = new List<string>();
        ...
        /// </summary>
        private string DoExpression(DescribeUnfold u, Describe10Parser.ExpressionContext context)
        {
            int childCount = context.ChildCount;
        ...
        /// </summary>
        private string DoItem(DescribeUnfold u, Describe10Parser.ItemContext context)
        {
            int childCount = context.ChildCount;
            string text = "";
            string tag = "";
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                else if (child is Describe10Parser.Text_chunkContext)
                {
