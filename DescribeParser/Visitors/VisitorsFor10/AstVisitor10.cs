...
{
    /// <summary>
    /// An Ast visitor for Describe Language version 1.0
    ...
    public class AstVisitor10
    {
        ...
        public AstScriptureNode TranslateScripture(Describe10Parser.ScriptureContext context, string filename = "")
        {
            List<AstExpressionNode> expressions = new List<AstExpressionNode>();
            IParseTree child = context.GetChild(0);
            if (child is Describe10Parser.ExpressionContext)
            {
                AstExpressionNode expr = DoExpression((child as Describe10Parser.ExpressionContext)!);
                expressions.Add(expr);
            }
            else if (child is Describe10Parser.Expression_listContext)
            {
                expressions = DoExpressionList((child as Describe10Parser.Expression_listContext)!);
            }
            else
            {
        ...
        /// </summary>
        private List<AstExpressionNode> DoExpressionList(Describe10Parser.Expression_listContext context)
        {
            ...
            {
                var child = context.GetChild(i) as Describe10Parser.ExpressionContext;
                if (child == null)
                {
                    throw new ArgumentException(
        ...
        /// </summary>
        private AstExpressionNode DoExpression(Describe10Parser.ExpressionContext context)
        {
            // sanity check
            int childCount = context.ChildCount;
            ...
            // get title item
            var firstChild = context.GetChild(0) as Describe10Parser.ItemContext;
            if (firstChild == null)
            {
                throw new ArgumentException(
            ...
            // get arrow leaf
            var secondChild = context.GetChild(1) as Describe10Parser.ProducerContext;
            if (secondChild == null)
            {
                throw new ArgumentException(
        ...
        /// </summary>
        private List<AstExpressionLineNode> DoItemOrExpressionList(Describe10Parser.Item_or_expression_listContext context)
        {
            int childCount = context.ChildCount;
            List<AstExpressionLineNode> lines = new List<AstExpressionLineNode>();
        ...
        /// "item_or_expression_part : expression (SEPARATOR)? ;"
        /// </summary>
        private AstExpressionLineNode DoItemOrExpressionPart(Describe10Parser.Item_or_expression_partContext context)
        {
            int childCount = context.ChildCount;
        ...
        /// </summary>
        private AstItemNode DoItem(Describe10Parser.ItemContext context)
        {
            int childCount = context.ChildCount;
        ...
        private AstLeafNode doProductionArrow(Describe10Parser.ProducerContext context)
        {
            int childCount = context.ChildCount;
