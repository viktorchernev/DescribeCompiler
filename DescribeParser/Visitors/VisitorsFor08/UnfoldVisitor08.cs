...
{
    public class UnfoldVisitor08 : Describe08BaseVisitor<object>, IUnfoldVisitor
    {
        // Misc
        ...
        /// <param name="context">Root context produced by the parser aka the parse tree</param>
        /// <returns>True if successful</returns>
        public bool DoScripture(DescribeUnfold u, Describe08Parser.ScriptureContext context, string filename = "")
        {
