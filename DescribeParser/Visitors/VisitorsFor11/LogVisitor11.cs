...
namespace DescribeParser.Visitors
{
    ...
    /// </summary>
    public class LogVisitor11 : Describe11BaseVisitor<object>
    {
        /// <summary>
        /// Ctor.
        /// </summary>
            ...
            for (int i = 0; i < childCount; i++)
            {
                ...
                else if (child is ParserRuleContext childContext)
                {
                    if (child is Describe11Parser.ExpressionContext)
                        VisitExpression((Describe11Parser.ExpressionContext)child);
                    else if (child is Describe11Parser.Expression_listContext)
                        VisitExpression_list((Describe11Parser.Expression_listContext)child);
                    else if (child is Describe11Parser.ItemContext)
                        VisitItem((Describe11Parser.ItemContext)child);
                    else if (child is Describe11Parser.Item_or_expression_listContext)
                        VisitItem_or_expression_list((Describe11Parser.Item_or_expression_listContext)child);
                    else if (child is Describe11Parser.Item_or_expression_partContext)
                        VisitItem_or_expression_part((Describe11Parser.Item_or_expression_partContext)child);
                    else if (child is Describe11Parser.Text_chunkContext)
                        VisitText_chunk((Describe11Parser.Text_chunkContext)child);
                    else if (child is Describe11Parser.ProducerContext)
                        VisitProducer((Describe11Parser.ProducerContext)child);
                }
        ...
        public override string VisitScripture([NotNull] Describe11Parser.ScriptureContext context)
        {
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitProducer([NotNull] Describe11Parser.ProducerContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitText_chunk([NotNull] Describe11Parser.Text_chunkContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitItem([NotNull] Describe11Parser.ItemContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitExpression([NotNull] Describe11Parser.ExpressionContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitExpression_list([NotNull] Describe11Parser.Expression_listContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitItem_or_expression_list([NotNull] Describe11Parser.Item_or_expression_listContext context)
        {
            Validators.ValidateParserRuleContext(context);
        ...
        /// <returns>A string indicating the success or failure of the visit.</returns>
        public override string VisitItem_or_expression_part([NotNull] Describe11Parser.Item_or_expression_partContext context)
        {
            Validators.ValidateParserRuleContext(context);
