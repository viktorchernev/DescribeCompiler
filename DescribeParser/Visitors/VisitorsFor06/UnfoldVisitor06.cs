...
namespace DescribeParser.Visitors
{
    ...
    /// For Describe Language version 0.6
    /// </summary>
    public class UnfoldVisitor06
    {
        ...
        public bool TranslateScripture(DescribeUnfold u, Describe06Parser.ScriptureContext context, string filename = "")
        {
        ...
        /// </summary>
        private string[] DoExpressionList(DescribeUnfold u, Describe06Parser.Expression_listContext context, bool isPrimery = false)
        {
        ...
        /// </summary>
        private string[] DoItemOrExpressionList(DescribeUnfold u, Describe06Parser.Item_or_expression_listContext context)
        {
            int childCount = context.ChildCount;
            List<string> keys = new List<string>();
        ...
        /// </summary>
        private string DoExpression(DescribeUnfold u, Describe06Parser.ExpressionContext context)
        {
            int childCount = context.ChildCount;
        ...
        /// "item : (text_chunk)+ ;"
        /// </summary>
        private string DoItem(DescribeUnfold u, Describe06Parser.ItemContext context)
        {
            int childCount = context.ChildCount;
            string text = "";
            for (int i = 0; i < childCount; i++)
            {
                ...
                {
                    throw new ArgumentException(
                        $"The child at index {i} of the provided ItemContext is not a valid Text_chunkContext.",
                        nameof(child));
                }
