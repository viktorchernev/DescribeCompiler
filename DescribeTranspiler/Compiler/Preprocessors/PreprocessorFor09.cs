...
{
    /// <summary>
    /// A preprocessor for Describe 0.9 source code.
    /// </summary>
    public class PreprocessorFor09 : IDescribePreprocessor
    {
        private DescribeCompiler _Compiler;


        /// <summary>
        /// Preprocess Describe 0.9 source code
        /// </summary>
        ...
        public PreprocessorFor09(DescribeCompiler compiler)
        {
            _Compiler = compiler;
        }
