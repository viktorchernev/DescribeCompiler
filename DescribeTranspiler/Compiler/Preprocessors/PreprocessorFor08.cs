...
{
    /// <summary>
    /// A preprocessor for Describe 0.8 source code.
    /// </summary>
    public class PreprocessorFor08 : IDescribePreprocessor
    {
        private DescribeCompiler _Compiler;


        /// <summary>
        /// Preprocess Describe 0.8 source code
        /// </summary>
        ...
        public PreprocessorFor08(DescribeCompiler compiler)
        {
            _Compiler = compiler;
        }
