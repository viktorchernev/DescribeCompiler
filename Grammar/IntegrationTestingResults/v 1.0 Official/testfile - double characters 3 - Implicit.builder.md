...
Shift                14                                                     The parser shifted to state 14                                            
Token Read           14       2       8   \\                                Token type: EscapeBSlash                                                  
Reduce               20                   (15) ::=     wool                 <text-chunk> ::= Text                                                     
Shift                 1                                                     The parser shifted to state 1                                             
Token Read            1       2      10   fabrics                           Token type: Text                                                          
Reduce               33                   (16) ::= \\                       <text-chunk> ::= EscapeBSlash                                             
Shift                14                                                     The parser shifted to state 14                                            
...
Shift                99                                                     The parser shifted to state 99                                            
Token Read           99       4       4   \\                                Token type: EscapeBSlash                                                  
Reduce               70                   (28) ::= , ,                      <separator> ::= Separator Separator                                       
Shift                 1                                                     The parser shifted to state 1                                             
Token Read            1       4       6    silk                             Token type: Text                                                          
Reduce               20                   (29) ::= \\                       <text-chunk> ::= EscapeBSlash                                             
Shift                14                                                     The parser shifted to state 14                                            
Token Read           14       4      12   \\                                Token type: EscapeBSlash                                                  
Reduce               33                   (30) ::=  silk                    <text-chunk> ::= Text                                                     
Shift                 1                                                     The parser shifted to state 1                                             
Token Read            1       4      14    fabrics                          Token type: Text                                                          
Reduce               33                   (31) ::= \\                       <text-chunk> ::= EscapeBSlash                                             
Shift                14                                                     The parser shifted to state 14                                            
...
Reduce               15                   (47) ::= (13) (14) (46)           <expression> ::= <item> <producer> <item-or-expression-list>              
Reduce               18                   (48) ::= (47)                     <scripture> ::= <expression>                                              
Accept               18                                                                                                                               
