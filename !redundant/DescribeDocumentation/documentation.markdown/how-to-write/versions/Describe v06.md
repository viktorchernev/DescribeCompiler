...
permalink: /language/version-06/
exclude: true
---
<br>Describe version 0.6, code-named Basics is the first test version of the language. It introduced the language in simple lists with separators ```,```, terminators ```;``` and production arrows ```->```.
