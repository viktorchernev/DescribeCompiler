...
Scripture : 
    ...
    filename - "Tests.Integration.Parser.TestFiles.TestFilesFor08.F_production_in_production1.ds"
    namespace - NULL
    Exception - NULL
