...
Scripture : 
    ...
    filename - "Tests.Integration.Parser.TestFiles.TestFilesFor06.D_escaped_double_characters3.ds"
    namespace - NULL
    Exception - NULL
