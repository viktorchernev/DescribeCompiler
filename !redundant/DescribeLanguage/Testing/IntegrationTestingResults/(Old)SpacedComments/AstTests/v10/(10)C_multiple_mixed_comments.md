...
Scripture : 
    ...
    filename - "Tests.Integration.Parser.TestFiles.TestFilesFor10.C_multiple_mixed_comments.ds"
    namespace - NULL
    Exception - NULL
