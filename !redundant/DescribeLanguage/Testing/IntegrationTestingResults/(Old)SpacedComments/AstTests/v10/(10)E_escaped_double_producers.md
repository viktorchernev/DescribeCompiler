...
Scripture : 
    ...
    filename - "Tests.Integration.Parser.TestFiles.TestFilesFor10.E_escaped_double_producers.ds"
    namespace - NULL
    Exception - NULL
