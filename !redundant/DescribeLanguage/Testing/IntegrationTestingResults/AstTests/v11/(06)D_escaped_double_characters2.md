...
Scripture : 
    ...
    filename - "Tests.Integration.Parser.TestFiles.TestFilesFor06.D_escaped_double_characters2.ds"
    namespace - NULL
    Exception - NULL
