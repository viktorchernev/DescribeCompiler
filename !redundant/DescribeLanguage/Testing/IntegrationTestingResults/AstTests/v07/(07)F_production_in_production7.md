...
Scripture : 
    ...
    filename - "Tests.Integration.Parser.TestFiles.TestFilesFor07.F_production_in_production7.ds"
    namespace - NULL
    Exception - NULL
