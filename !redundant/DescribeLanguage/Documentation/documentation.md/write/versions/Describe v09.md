...
exclude: true
---
Describe version 0.9, codenamed Decorators is the forth test version of the language. It introduced the concept of decorators - pieces of particular data with their own syntaxis, enclosed in curly brackets  - ```{color|tomato}{bold}```
